...
extension ExtensionConfirmBacsDebitSetup on Stripe {
  _JS get js => this as _JS;

  /// Use stripe.confirmBacsDebitSetup in the BACS Direct Debit with Setup Intents flow when the customer submits your payment form. When called, it will confirm the SetupIntent with data you provide. Note that there are some additional requirements to this flow that are not covered in this reference. Refer to our integration guide for more details.
  ...
  Future<SetupIntentResponse> confirmBacsDebitSetup(
    ...
    return parseSetupIntentResponse(
      js.confirmBacsDebitSetup(clientSecret, jsData),
    );
  }
}
...
@JS()
abstract class _JS {
  external Promise<dynamic> confirmBacsDebitSetup(
    String clientSecret, [
    dynamic data,
  ]);
}
